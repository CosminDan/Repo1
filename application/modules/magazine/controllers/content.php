...
{
    protected $permissionCreate = 'Magazine.Content.Create';
    protected $permissionDelete = 'Magazine.Content.Delete';
    protected $permissionEdit   = 'Magazine.Content.Edit';
    protected $permissionView   = 'Magazine.Content.View';
    ...
    public function index($offset = 0)
    {
        ...
        $records = $this->issues_model->find_all();
