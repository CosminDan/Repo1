 ...
 */
if (! function_exists('_form2_common')) {
     ...
     */
    function _form2_common($type = 'text', $data = '', $value = '', $label = '', $extra = '', $tooltip = '')
    {
        $defaults = array(
...
if (! function_exists('form2_input')) {
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function form2_input($data = '', $value = '', $label = '', $extra = '', $tooltip = '')
    {
        return _form2_common('text', $data, $value, $label, $extra, $tooltip);
    }
}
...
if (! function_exists('form2_textarea')) {
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function form2_textarea($data = '', $value = '', $label = '', $extra = '', $tooltip = '')
    {
        $defaults = array(
            'name' => (is_array($data) ? '' : $data),
        );
